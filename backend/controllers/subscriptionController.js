  ...
  try {
    ...
    const presetPlans = [
      ...
      },
      {
        ...
        description: "Additional networking opportunities and priority registration",
        recommended: true,
      },
      {
        id: 3,
        ...
        description: "Full access with exclusive mentorship and premium sessions",
        recommended: false,
      },
    ]
  ...
  try {
    ...
    if (subRecord) {
      ...
      await Order.create({
        ...
        subscription_id: subscription.id,
        is_subscription: true,
        notes: JSON.stringify({ subscription_payment: true, charge_cycle: subscription.paid_count }),
      })
