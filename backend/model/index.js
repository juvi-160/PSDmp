...
User.hasMany(EventRSVP, { foreignKey: "user_id",  as: "rsvps" });
User.hasMany(EventFeedback, { foreignKey: "user_id",  as: "feedbacks" });
User.hasMany(Order, { foreignKey: "user_id",  as: "orders" });
User.hasMany(Ticket, { foreignKey: "user_id",  as: "tickets" });
User.hasMany(TicketResponse, { foreignKey: "user_id",  as: "responses" });
User.hasMany(Ticket, { foreignKey: "admin_id",  as: "managedTickets" });
...
EventRSVP.belongsTo(User, { foreignKey: "user_id",  as: "user" });
...
Ticket.belongsTo(User, { foreignKey: "admin_id", as: "admin", constraints: false });
Ticket.hasMany(TicketResponse, { foreignKey: "ticket_id", as: "responses" });

// TicketResponse associations
TicketResponse.belongsTo(User, { foreignKey: "user_id", as: "user" });
